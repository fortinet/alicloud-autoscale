...
const
    ...
    /(?:^|(?:\s*))\s*config?\s*system?\s*auto-scale[\s]*((?:.|\s)*)\bend\b/;
...
module.exports = class AutoscaleHandler {
    ...
    async getBaseConfig(configName) {
        let baseConfig = await this.getConfigSet(configName);
    ...
    // I believe this acutally sets stuff
    ...
    async setScalingGroup(master, self) {
